...
import './MyStore.scss'
import { findStoreByEmail, getProfileImage, getStoreImage } from '../../../services/apiService';
...
const MyStore = () => {
    ...
    useEffect(() => {
      ...
      const getStorePhoto = async () => {
        try {
            const imageData = await getStoreImage('2d87593c-64fd-425d-b8cf-730b2a0ea5b7.png');
